...
1. Gather context – read the documents in the lessons folder. All folders will start with `Lesson` followed by a number single digit numbers might or might not have a leading 0.
